...
class DataLoader:
    ...
    def get_data(self):
        ...
        df_clear = train_df[train_df['label'].isin(only_labels)]
    ...
    def get_data2(self, min_label_count=100):
        '''
        ...
        df_clear = train_df[train_df['label'].isilabels.txtn(clear_labels)]
